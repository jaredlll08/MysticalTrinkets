...
/**
 * @author Azanor This interface is used by tiles that use or transport vis.
 *         Only tiles that implement this interface will be able to connect to
 *         vis conduits or other thaumic devices
 */
public interface IEssentiaTransport {
	/**
	 * Is this tile able to connect to other vis users/sources on the specified
	 * side?
	 * 
	 * @param face
	 * @return
	 ...
	 * @return a return type of null indicates the suction is untyped and the
	 *         first thing available will be drawn
	 */
	...
	/**
	 * Essentia will not be drawn from this container unless the suction exceeds
	 * this amount.
	 * 
	 * @return the amount
	 */
	...
	/**
	 * Return true if you want the conduit to extend a little further into the
	 * block. Used by jars and alembics that have smaller than normal hitboxes
	 * 
	 * @return
	 */
