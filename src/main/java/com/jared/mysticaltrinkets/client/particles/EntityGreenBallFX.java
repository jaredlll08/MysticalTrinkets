...
public class EntityGreenBallFX extends EntityFX {
	/** the scale of the flame FX */
	private float flameScale;

	public EntityGreenBallFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12) {
		...
		this.particleMaxAge = 20;// (int) (8.0D / (Math.random() * 0.4D + 0.1D))
									// + 2;
		this.noClip = true;
