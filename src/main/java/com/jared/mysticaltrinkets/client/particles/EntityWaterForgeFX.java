...
public class EntityWaterForgeFX extends EntityFX {
	...
	public EntityWaterForgeFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12) {
		...
		this.particleTextureIndexY = 6;
		this.particleRed = this.particleGreen = this.particleBlue = 1.0F;
		this.particleMaxAge = 15;// (int) (8.0D / (Math.random() * 0.4D + 0.1D))
									// + 2;
		this.noClip = true;
	...
	public void onUpdate() {
		...
		this.posY = this.field_70567_ar + this.motionY / f;
		;
