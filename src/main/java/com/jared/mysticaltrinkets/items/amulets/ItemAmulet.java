...
public class ItemAmulet extends Item implements IBauble {
	...
	public void registerIcons(IIconRegister icon) {
		...
		this.amulet = icon.registerIcon(ModInfo.modid + ":Amulet");
		this.overlay = icon.registerIcon(ModInfo.modid + ":Amulet_Overlay");
