...
public class ItemMysticalBoots extends ItemArmor implements ISpecialArmor {
	...
	public ItemMysticalBoots(int type) {
	...
	public void registerIcons(IIconRegister icon) {
		this.itemIcon = icon.registerIcon(ModInfo.modid + ":Mystical_Boots");
		this.amulet = icon.registerIcon(ModInfo.modid + ":Mystical_Boots");
		this.overlay = icon.registerIcon(ModInfo.modid + ":Mystical_Boots_Overlay");
	...
	// String type) {
	// return !(stack.getItem() == MysticalTools.mysticalLeggs) ? ModInfo.modid
	// + ":textures/armor/Mystical_Layer_1.png" : ModInfo.modid +
	// ":textures/armor/Mystical_Layer_2.png";
	// }
