...
public class ItemMysticalHelmet extends ItemArmor implements ISpecialArmor {
	...
	public ItemMysticalHelmet(int type) {
		super(MysticalTools.Mystical_Metal_Armor, "mystical".length(), 0);
	...
	public void registerIcons(IIconRegister icon) {
		this.itemIcon = icon.registerIcon(ModInfo.modid + ":Mystical_Helmet");
		this.amulet = icon.registerIcon(ModInfo.modid + ":Mystical_Helmet");
		this.overlay = icon.registerIcon(ModInfo.modid + ":Mystical_Helmet_Overlay");
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
		return !(stack.getItem() == MysticalTools.mysticalLeggsNormal) ? ModInfo.modid + ":textures/armor/Mystical_Layer_1.png" : ModInfo.modid + ":textures/armor/Mystical_Layer_2.png";
	}
