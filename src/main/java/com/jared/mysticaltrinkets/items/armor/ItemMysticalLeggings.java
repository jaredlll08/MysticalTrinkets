...
public class ItemMysticalLeggings extends ItemArmor implements ISpecialArmor {
	...
	public ItemMysticalLeggings(int type) {
	...
	public void registerIcons(IIconRegister icon) {
		this.itemIcon = icon.registerIcon(ModInfo.modid + ":Mystical_Leggings");
		this.amulet = icon.registerIcon(ModInfo.modid + ":Mystical_Leggings");
		this.overlay = icon.registerIcon(ModInfo.modid + ":Mystical_Leggings_Overlay");
