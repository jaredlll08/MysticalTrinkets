...
public class ItemRing extends Item implements IBauble {
	...
	public void registerIcons(IIconRegister icon) {
		this.ring = icon.registerIcon(ModInfo.modid + ":Ring");
		this.overlay = icon.registerIcon(ModInfo.modid + ":Ring_Overlay");
	}
