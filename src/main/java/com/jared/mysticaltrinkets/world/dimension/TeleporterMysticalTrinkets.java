...
public class TeleporterMysticalTrinkets extends Teleporter {
	...
	public TeleporterMysticalTrinkets(WorldServer par1WorldServer) {
	...
	public void placeInPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
		if (this.worldServerInstance.provider.dimensionId != 1) {
			...
			this.worldServerInstance.setBlock(i, j, k, Blocks.air);
	...
	//
	// if (l3 < 0 && !this.worldServerInstance.getBlockMaterial(k4, j4,
	// l4).isSolid() || l3 >= 0 && !this.worldServerInstance.isAirBlock(k4, j4,
	// l4))
	// {
	// continue label274;
	// }
	...
	// j4 = j2 + (j3 - 1) * k3;
	//
	// if (i4 < 0 && !this.worldServerInstance.getBlockMaterial(l3, k4,
	// j4).isSolid() || i4 >= 0 && !this.worldServerInstance.isAirBlock(l3, k4,
	// j4))
	// {
	// continue label222;
	// }
	...
	// this.worldServerInstance.setBlock(k3, j3, i4, flag ?
	// ConfigManager.portalFrame : SkyBlocks.portal.blockID, 0, 2);
	// }
	// }
	//
	// for (i3 = 0; i3 < 4; ++i3)
